...
def getErrorRanges(errorFrame,stdev,range):
    acceptable = stdev * range
    ranges = []
    s=-1
    prevErr = False
...
if __name__ == "__main__":
    ...
    errorFrame = actual["Concentration"].sub(predicted[0]).abs()
    stdev = errorFrame.mean()
    print(errorFrame)
    print(stdev)

    print(getErrorRanges(errorFrame, stdev, 1.5))
